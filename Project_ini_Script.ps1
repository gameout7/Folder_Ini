...
function read-projectdata2
    {
        ...
        # Section General                
                        ...
                        if ($SpliteArray[0].trim('') -eq "ProjectNumber") {[int]$ProjectNumber = $SpliteArray[1].trim('')}
        ...
        Write-Host "Project Code is $ProjectCode"
        Write-Host "Project Number is $ProjectNumber"    
        Write-Host "Project Engineer is $ProjectEngineer"
        Write-Host "Project Manager is $projectManager"
        Write-Host "Project Company is $projectCompany"
        Write-Host "Project Country is $projectCountry"
#>
...
#        Write-Host "Number of Documents is $DocumentQty"
        ...
        foreach ($item in $ProjectItems) 
            {   
                ...
                write-host $item.ItemItemTemplate
#                write-host "`n"   
            }
    }
